...
public final class SportRaceListRsp extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    ...
    public void readFrom(com.duowan.taf.jce.JceInputStream _is)
    {
        if(null == cache_allRaceList)
        {
            ...
            String __var_63 = "";
            java.util.ArrayList<com.duowan.gamenews.RaceInfo> __var_64 = new java.util.ArrayList<com.duowan.gamenews.RaceInfo>();
            com.duowan.gamenews.RaceInfo __var_65 = new com.duowan.gamenews.RaceInfo();
            ((java.util.ArrayList<com.duowan.gamenews.RaceInfo>)__var_64).add(__var_65);
            cache_allRaceList.put(__var_63, __var_64);
        }
        ...
        if(null == cache_sportList)
        {
            ...
            com.duowan.gamenews.sportInfo __var_66 = new com.duowan.gamenews.sportInfo();
            ((java.util.ArrayList<com.duowan.gamenews.sportInfo>)cache_sportList).add(__var_66);
        }
