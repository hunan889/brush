...
set TARGET_SVN_PATH="https://svn.yy.com/dwjs/code/carbrush/android/trunk"
set CUSTOME_SVN_PATH="https://svn.yy.com/dwjs/code/sportbrush/android/customize/carbrush"
