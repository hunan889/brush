...
{
    private static ServiceType[] __values = new ServiceType[5];
    private int __value;
    ...
    public static final int _ST_GET_WELCOME_CHANNEL_lIST = 16;
    public static final ServiceType ST_GET_WELCOME_CHANNEL_lIST = new ServiceType(4,_ST_GET_WELCOME_CHANNEL_lIST,"ST_GET_WELCOME_CHANNEL_lIST");
